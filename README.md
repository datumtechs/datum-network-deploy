...
pinata_gateway = <待填写>
#凭证工厂合约地址
data_token_factory_address = '0x1D3ee03b5CF808005886873311E33A4D948456C4'
#router合约地址
dex_router_address = '0x4378dAF745E9053f6048c4f78c803f3bC8829703'
#dex链接地址
dex_web_url = http://10.10.8.181:8080/swap
#网络名称
chain_name = PlatON开发网
#链 ID
chain_id = 2203181
#链rpcUrl，给用户使用，必须是外部ip
rpc_url = https://devnetopenapi2.platon.network/rpc
#货币符号
symbol = LAT
#区块浏览器
block_explorer_url = https://devnetscan.platon.network/
#钱包地址前缀hrp
hrp = lat
#链rpcUrl，主要是给后台系统用，可以是内部IP
rpc_url_list = https://devnetopenapi2.platon.network/rpc
#有属性凭证工厂合约地址
attribute_data_token_factory_address = '0x6FCf0573c4d95fc927d4319f2f859638d8c8492a'
#有属性凭证交易所地址，格式为<交易所名称,交易所地址>，多个交易所以英文逗号分割
attribute_data_token_exchange = <tofunft交易所|https://tofunft.com/>
#投票合约合约地址,需要用单引号括起来
vote_contract_address = <待填写>
#投票合约部署的区块，这个配置决定了事件从哪个区块开始读取
vote_contract_deploy_bn = <待填写>
